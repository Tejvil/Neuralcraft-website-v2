...
def add_application_to_db(job_id, data):
  with engine.connect() as conn:
    query = text("INSERT INTO applications(job_id, first_name, last_name, email, dob,job_role, address, city, pincode, resume) VALUES(:job_id, :first_name, :last_name, :email, :dob, :job_role, :address, :city, :pincode, :resume)")
    conn.execute(query, {
        'job_id': job_id,
